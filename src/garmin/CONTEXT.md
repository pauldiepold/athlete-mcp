...
**Verschleppte Tage**:
Die offenen Tage des *Erstbefüllungs*-Fensters, die **außerhalb** des *Nachlauffensters* liegen — die letzten 30 Tage minus dem, was der nächtliche Cron ohnehin nachholt. Der Unterschied ist der zwischen „wird morgen früh von selbst voll" und „bleibt leer, bis jemand drückt": Ein fehlender Tag von gestern ist der Normalfall, Tage jenseits der 14 erreicht nur noch der Knopf des Athleten (oder ein Backfill von Hand). Deshalb hängt die Frage, ob eine Fläche ein löchriges Fenster überhaupt **anspricht**, an dieser Zahl und nicht an den offenen Tagen (Issue #67) — sonst meldete sie an den meisten Morgen etwas und wäre Tapete. Wie viel ein Klick dann zu tun hätte, sagen weiterhin die offenen Tage: Geholt wird jeder von ihnen, auch die innerhalb des Fensters.
_Vermeide_: alte Lücken, unheilbare Tage
